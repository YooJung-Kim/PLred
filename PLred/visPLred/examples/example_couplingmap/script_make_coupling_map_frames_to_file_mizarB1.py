...
psfcam = 'palila'
psfcam_frames_name = '/mnt/datazpool/PL/yjkim/reduced/mizarB1_20250514/first_palila_matched_fastcam_matched_frames.npy'
psfcam_timestamp_name = '/mnt/datazpool/PL/yjkim/reduced/mizarB1_20250514/first_palila_matched.pkl'
...
sd.bin_by_centroids(25, 5, calculate_variance = False,
                    to_file = True,
                    filename = '/mnt/datazpool/PL/yjkim/remapped/mizarB1_20250514/remapped')#, return_bootstrap_samples= True)
